...
items:
  - title: "Lens"
    ...
    description: "Quick, self-service exploration of a single dataset — group, filter, and switch chart types to get a fast answer."
  - title: "Dashboard"
  ...
  - title: "App"
    ...
    description: "A folder that groups dashboards, lenses, datasets, and stories — and controls access and sharing."
---
::
