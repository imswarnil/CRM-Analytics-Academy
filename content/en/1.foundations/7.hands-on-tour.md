...
1. **Design** — Analytics Studio, dashboards, lenses, favorites, and subscriptions.
2. **Data** — the Data Manager: Monitor, dataflows, recipes, datasets, and connections.
3. **Intelligence** — a story with what-if analysis, evaluation metrics, and deployment.
